export default function PortfolioOver() {
    return (
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
            ...
            <div>
              <div className="mt-10">
                ...
                <a
                  href="#"
                  className="inline-block rounded-md border-green-600 border-[2px] bg-black px-8 py-3 text-center font-medium text-white hover:bg-green-500"
                >
                  Shop Collection
                </a>
              </div>
