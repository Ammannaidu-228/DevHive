  ...
  return (
    <div>
      ...
      <div className="isolate bg-black px-6 py-24 sm:py-32 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl border-blue-500 rounded-xl border-[2px] p-3 text-center">
        ...
        >
          ...
          <div className="mt-10">
            <button
              type="submit"
              className="block w-full rounded-md border-green-500 border-[2px] px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
            >
              Let&apos;s talk
            </button>
          </div>
